...
/***/ "./src/js/common/components/AppShell.tsx":
/*!***********************************************!*\
  !*** ./src/js/common/components/AppShell.tsx ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var _containers_appShellContainerWrapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../containers/appShellContainerWrapper */ "./src/js/common/containers/appShellContainerWrapper.ts");
...
class AppShell extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  componentDidMount() {
    const {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_containers_appShellContainerWrapper__WEBPACK_IMPORTED_MODULE_1__["default"])(AppShell));
...
/***/ "./src/js/common/containers/appShellContainerWrapper.ts":
/*!**************************************************************!*\
  !*** ./src/js/common/containers/appShellContainerWrapper.ts ***!
  \**************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _redux_actions_userActions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../redux/actions/userActions */ "./src/js/redux/actions/userActions.ts");
/* eslint-disable @typescript-eslint/no-explicit-any */
...
const mapDispatchToProps = dispatch => ({
  getUserDetails: () => dispatch(Object(_redux_actions_userActions__WEBPACK_IMPORTED_MODULE_1__["getUserDetails"])({}))
});

const appShellContainerWrapper = Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mapStateToProps, mapDispatchToProps);
/* harmony default export */ __webpack_exports__["default"] = (appShellContainerWrapper);
...
/***/ "./src/js/redux/actions/defaults.ts":
/*!******************************************!*\
  !*** ./src/js/redux/actions/defaults.ts ***!
  \******************************************/
/*! exports provided: NOOP_ACTION */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NOOP_ACTION", function() { return NOOP_ACTION; });
/* eslint-disable import/prefer-default-export */
const NOOP_ACTION = 'NOOP_ACTION';

/***/ }),

/***/ "./src/js/redux/actions/userActions.ts":
/*!*********************************************!*\
  !*** ./src/js/redux/actions/userActions.ts ***!
  \*********************************************/
/*! exports provided: GET_USER, GET_USER_REQUEST, GET_USER_FAILURE, GET_USER_FINALLY, getUserDetails */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GET_USER_FINALLY", function() { return GET_USER_FINALLY; });
...
const GET_USER_REQUEST = `${GET_USER}_REQUEST`;
const GET_USER_FAILURE = `${GET_USER}_FAILURE`;
const GET_USER_FINALLY = `${GET_USER}_FINALLY`;
function getUserDetails(payload) {
  return {
    type: GET_USER,
    promise: _common_utils_apiClient__WEBPACK_IMPORTED_MODULE_7__["default"].get('/api/v1/auth/user-details', _objectSpread({}, payload)),
...
/* harmony import */ var _middlewares_apiPromiseHandler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./middlewares/apiPromiseHandler */ "./src/js/redux/middlewares/apiPromiseHandler.ts");
/* harmony import */ var _reducers_rootReducer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./reducers/rootReducer */ "./src/js/redux/reducers/rootReducer.ts");
...
const middlewares = [redux_thunk__WEBPACK_IMPORTED_MODULE_8___default.a, _middlewares_apiPromiseHandler__WEBPACK_IMPORTED_MODULE_9__["default"]];

function createReducer(asyncReducers) {
  return Object(redux__WEBPACK_IMPORTED_MODULE_7__["combineReducers"])(_objectSpread({}, _reducers_rootReducer__WEBPACK_IMPORTED_MODULE_10__["default"], {}, asyncReducers));
}
...
const appStore = (initialState, {
  ...
  const store = Object(redux__WEBPACK_IMPORTED_MODULE_7__["createStore"])(bootupReducer, initialState, Object(redux__WEBPACK_IMPORTED_MODULE_7__["compose"])(Object(redux__WEBPACK_IMPORTED_MODULE_7__["applyMiddleware"])(...middlewares, ...extraMiddlewares), devTools));
  store.asyncReducers = {};
...
/***/ "./src/js/redux/middlewares/apiPromiseHandler.ts":
/*!*******************************************************!*\
  !*** ./src/js/redux/middlewares/apiPromiseHandler.ts ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return apiMiddleware; });
/* harmony import */ var _babel_runtime_corejs2_core_js_object_define_property__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/object/define-property */ "./node_modules/@babel/runtime-corejs2/core-js/object/define-property.js");
/* harmony import */ var _babel_runtime_corejs2_core_js_object_define_property__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_object_define_property__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_corejs2_core_js_object_define_properties__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/object/define-properties */ "./node_modules/@babel/runtime-corejs2/core-js/object/define-properties.js");
/* harmony import */ var _babel_runtime_corejs2_core_js_object_define_properties__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_object_define_properties__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var lodash_has__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! lodash/has */ "lodash/has");
...
/* harmony import */ var _sentry_browser__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @sentry/browser */ "@sentry/browser");
/* harmony import */ var _sentry_browser__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_sentry_browser__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _common_constants_httpStatusCodes__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../common/constants/httpStatusCodes */ "./src/js/common/constants/httpStatusCodes.ts");
  ...
  return next => action => {
    ...
    const {
      ...
      onAPIFailure = x => x
          ...
          rest = Object(_babel_runtime_corejs2_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_8__["default"])(action, ["promise", "type", "transformer", "transformKey", "transformParams", "onAPISuccess", "onAPIFailure"]); // eslint-disable-next-line @typescript-eslint/no-misused-promises
    ...
    return promise.then(res => {
      ...
      if (!_babel_runtime_corejs2_core_js_array_is_array__WEBPACK_IMPORTED_MODULE_6___default()(res) && !lodash_has__WEBPACK_IMPORTED_MODULE_9___default()(res, keyToTransform)) {
        throw new Error('transformKey not found in response.');
      }

      const dataToTransform = _babel_runtime_corejs2_core_js_array_is_array__WEBPACK_IMPORTED_MODULE_6___default()(res) ? res : lodash_get__WEBPACK_IMPORTED_MODULE_10___default()(res, keyToTransform);
      ...
      next(_objectSpread({}, rest, {
        status: _common_constants_httpStatusCodes__WEBPACK_IMPORTED_MODULE_12__["HTTP_OK"],
        transformed,
        type: SUCCESS
      }));
    }).catch(error => {
      ...
      if (status > _common_constants_httpStatusCodes__WEBPACK_IMPORTED_MODULE_12__["HTTP_NOT_FOUND"]) {
        Object(_sentry_browser__WEBPACK_IMPORTED_MODULE_11__["captureException"])(error);
      }
...
/***/ "./src/js/redux/reducers/rootReducer.ts":
/*!**********************************************!*\
  !*** ./src/js/redux/reducers/rootReducer.ts ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _userReducer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./userReducer */ "./src/js/redux/reducers/userReducer.ts");
/* harmony import */ var _actions_defaults__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../actions/defaults */ "./src/js/redux/actions/defaults.ts");
...
const emptyReducer = (state = {}, action) => {
  switch (action.type) {
    case _actions_defaults__WEBPACK_IMPORTED_MODULE_1__["NOOP_ACTION"]:
      {
        return state;
      }
...
/* harmony default export */ __webpack_exports__["default"] = (initReducers);

/***/ }),

/***/ "./src/js/redux/reducers/userReducer.ts":
/*!**********************************************!*\
  !*** ./src/js/redux/reducers/userReducer.ts ***!
  \**********************************************/
...
/* harmony import */ var _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @babel/runtime-corejs2/helpers/esm/defineProperty */ "./node_modules/@babel/runtime-corejs2/helpers/esm/defineProperty.js");
/* harmony import */ var _actions_userActions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../actions/userActions */ "./src/js/redux/actions/userActions.ts");
...
function userReducer(state = initialState, action) {
  switch (action.type) {
    case _actions_userActions__WEBPACK_IMPORTED_MODULE_7__["GET_USER_REQUEST"]:
      {
    ...
    case _actions_userActions__WEBPACK_IMPORTED_MODULE_7__["GET_USER"]:
      {
        return _objectSpread({}, state, {
          details: action.transformed,
          status: action.status
        });
      }

    case _actions_userActions__WEBPACK_IMPORTED_MODULE_7__["GET_USER_FAILURE"]:
      {
        return _objectSpread({}, state, {
          status: action.status
        });
    ...
    case _actions_userActions__WEBPACK_IMPORTED_MODULE_7__["GET_USER_FINALLY"]:
      {
        return _objectSpread({}, state, {
          isLoading: false
        });
...
/* harmony import */ var _js_redux_initAppStore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../js/redux/initAppStore */ "./src/js/redux/initAppStore.js");
/* harmony import */ var _js_common_utils_server__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../js/common/utils/server */ "./src/js/common/utils/server.ts");
/* harmony import */ var _js_common_components_AppShell__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../js/common/components/AppShell */ "./src/js/common/components/AppShell.tsx");
...
var _jsxFileName = "/Users/brickbolt/React/bricknbolt/updated/foundation-react-ui/src/pages/_app.tsx";
...
if (_config_config__WEBPACK_IMPORTED_MODULE_9___default.a.IS_DEV_ENV) {
  const loggerMiddleware = Object(redux_logger__WEBPACK_IMPORTED_MODULE_4__["createLogger"])();
  extraMiddlewares.push(loggerMiddleware); // eslint-disable-next-line no-underscore-dangle

  if (!_js_common_utils_server__WEBPACK_IMPORTED_MODULE_7__["isServer"]) {
    devTools = window.__REDUX_DEVTOOLS_EXTENSION__ ? window.__REDUX_DEVTOOLS_EXTENSION__() : x => x;
  }
}

const nextAppStore = emptyInitalState => Object(_js_redux_initAppStore__WEBPACK_IMPORTED_MODULE_6__["default"])(emptyInitalState, {
  devTools,
  extraMiddlewares
});
...
class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_3___default.a {
  ...
  render() {
    ...
    return __jsx(react_redux__WEBPACK_IMPORTED_MODULE_2__["Provider"], {
      ...
      __self: this
    }, __jsx(_js_common_components_AppShell__WEBPACK_IMPORTED_MODULE_8__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 48
      },
...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_5___default()(nextAppStore, {
  debug: _config_config__WEBPACK_IMPORTED_MODULE_9___default.a.ENVIRONMENT === 'development'
})(MyApp));
