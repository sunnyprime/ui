...
function isTestResultUpgradable(testResult) {
    const { vulnerabilities } = testResult;
...
function isTestResultPatchable(testResult) {
    const { vulnerabilities } = testResult;
